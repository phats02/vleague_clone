...
module.exports={
    getResultMath:async(page,perPage) =>{
        let match=await db.query(`select "td"."MaTranDau" as "MaTran" ,"d1"."MaDoi" as "MaDoi1","d1"."TenDoi" as "TenDoi1","d2"."MaDoi" as "MaDoi2", "d2"."TenDoi" as "Doi2","td"."SoBanThangDoi1" as "SoBanThangDoi1", "td"."SoBanThangDoi2" as "SoBanThangDoi2"
        from "TRANDAU" as "td","DOI" as "d1", "DOI" as "d2" 
        where "td"."SoBanThangDoi1" is not null and "td"."SoBanThangDoi2" is not null and "d1"."MaDoi"="td"."MaDoi1" and "d2"."MaDoi"="td"."MaDoi2" order by "td"."NgayGio" desc offset ${page*perPage} limit ${perPage}`)
    ...
    getPlayerOfTeam: async(maDoi)=>{
        let rs=await db.query(`Select "CAUTHU"."TenCauThu" as "TenCauThu", "LOAICAUTHU"."TenLoaiCauThu" as "LoaiCauThu",
